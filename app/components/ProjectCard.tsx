  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
      {mockProjects.map((project, idx) => (
        <div
          key={idx}
          className="group relative rounded-2xl glass-panel p-6 border border-black/10 dark:border-white/5 hover:border-cyan-accent/20 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,240,255,0.04)] flex flex-col justify-between overflow-hidden"
        >
      ...
      <div className="group relative rounded-2xl p-6 border border-dashed border-zinc-300 dark:border-zinc-800 hover:border-purple-accent/30 bg-purple-accent/[0.01] hover:bg-purple-accent/[0.02] transition-all duration-300 flex flex-col justify-between items-center text-center py-12 min-h-[300px]">
